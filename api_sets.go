...
func (r ApiGetSetsListRequest) Execute() (*ListEquipmentSets, *http.Response, error) {
...
// Execute executes the request
//  @return ListEquipmentSets
func (a *SetsAPIService) GetSetsListExecute(r ApiGetSetsListRequest) (*ListEquipmentSets, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
