...
type ConditionEntry struct {
	...
	Element *ConditionEntryElement `json:"element,omitempty"`
}
...
// SetElement gets a reference to the given ConditionEntryElement and assigns it to the Element field.
