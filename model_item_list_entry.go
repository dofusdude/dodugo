...
type ItemListEntry struct {
	...
	HasRecipe NullableBool `json:"has_recipe,omitempty"`
...
// GetHasRecipe returns the HasRecipe field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *ItemListEntry) GetHasRecipe() bool {
	if o == nil || o.HasRecipe.Get() == nil {
		var ret bool
		return ret
	}
	return *o.HasRecipe.Get()
}
...
// SetHasRecipe gets a reference to the given NullableBool and assigns it to the HasRecipe field.
func (o *ItemListEntry) SetHasRecipe(v bool) {
	o.HasRecipe.Set(&v)
}
// SetHasRecipeNil sets the value for HasRecipe to be an explicit nil
func (o *ItemListEntry) SetHasRecipeNil() {
	o.HasRecipe.Set(nil)
}
...
func (o ItemListEntry) MarshalJSON() ([]byte, error) {
	...
	if o.HasRecipe.IsSet() {
		toSerialize["has_recipe"] = o.HasRecipe.Get()
	}
	if o.Recipe != nil {
